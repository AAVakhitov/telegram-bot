...
public class NotificationSenderJob {
    ...
    public void sendNotification() {
        ...
        logger.info("Notification job started for current date time", currentDateTime);
        ...
        for (NotificationTask notificationTask : allByNotificationDateTime) {
            ...
            telegramBotSender.send(notificationTask.getChatID(), "Напоминание " + notificationTask.getMessage());
        }
        logger.info("notification job is done for datetime: " + currentDateTime);
    }
}
